...
public final class Main {
	...
	/**
	 * This is the constucter of the program. 
	 */
	private Main() {
	...
	public static void main(final String[] args) {
		...
		// Define variables.
		double userEntry, voltOption, resOption, ampOption;
		...
		if (userEntry == voltOption) {
			...
			// Set amperage equal to user input.
			proc.setAmperage(keyboard.nextDouble());
			// Ask user for resistance.
			System.out.println("Second, what is the resistance?");
			// Calculate Resistance
			proc.setResistance(keyboard.nextDouble());

			// Display a message with the amperage back to the user.
			proc.calculateVoltage();
			System.out.print("Alright, given your amperage of '" + proc.getAmperage());
			System.out.println(
					"' and your resistance of '" + proc.getResistance() + "' your voltage is: " + proc.getVoltage());
			// Close keyboard from future input.
			keyboard.close();
			...
			// Set voltage equal to user input.
			proc.setVoltage(keyboard.nextDouble());
			// Ask user for amperage.
			...
			// Display a message with the amperage back to the user.
			System.out.print("Alright, given your voltage of '" + proc.getVoltage());
			System.out.println(
					"' and your amperage of '" + proc.getAmperage() + "' the resistance is: " + proc.getResistance());
			...
			System.out.print("Alright, given your voltage of '" + proc.getVoltage());
			System.out.println(
					"' and your resistance of '" + proc.getResistance() + "' the amperage is: " + proc.getAmperage());
